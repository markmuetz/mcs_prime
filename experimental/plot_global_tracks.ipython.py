...
plot_tracks(
    dspf_at_time, display_trackresult=False, display_area=False, display_pf_area=False
)
plot_tracks(
    dspf_at_time, display_trackresult=False, display_area=True, display_pf_area=False
)
plot_tracks(
    dspf_at_time, display_trackresult=False, display_area=True, display_pf_area=True
)
pairs[0, 0]
